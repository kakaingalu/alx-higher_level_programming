...
Files | Description
------|------------
[tests/](./tests/) | a folder conatining all test cases.
[models/base.py](./models/base.py) | a file named models/base.py it will be the “base” of all other classes in this project.
[models/__init__.py](./models/__init__.py) | an empty file, this file makes the folder will become a Python package.
